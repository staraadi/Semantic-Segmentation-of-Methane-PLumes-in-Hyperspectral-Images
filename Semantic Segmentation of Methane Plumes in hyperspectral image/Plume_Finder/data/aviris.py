...
from Plume_Finder.utils import get_filesystem, read_json_from_gcp
import rasterio
...
THUILLER_SOLAR_IRRADIANCE = "gs://Plume_Finder/S2/Thuillier.csv"
SRF_WV3_FILE = "gs://Plume_Finder/WV3/WV3-SRF.csv"
SRF_S2_FILE ="gs://Plume_Finder/S2/S2-SRF_joint.csv"
...
def read_aviris(aviris_img_folder_or_path:str, columns_read:int=50,
    ...
    Examples:
        ...
        rdn = read_aviris("gs://Plume_Finder/Permian/data/ang20191007t175016/")

        # Image stored as a single GeoTIFF
        rdn = read_aviris("gs://Plume_Finder/Permian/images/ang20191007t175016.tif")
