...
from Plume_Finder.dataset_setup import get_dataset
from Plume_Finder.model_setup import get_model
from Plume_Finder.data.data_logger import ImageLogger
from hydra.utils import get_original_cwd
import logging
import fsspec
from Plume_Finder.validation import  run_validation
...
def train(settings : DictConfig) -> None:
    ...
    remote_path = os.path.join("gs://Plume_Finder/", folder_relative_name)
